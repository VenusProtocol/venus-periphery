    ...
    describe("Liquidator_2025_09_02", () => {
      ...
      describe("Sweep", () => {
        it("sweeps the remaining BTC to a specified address", async () => {
          const spent = parseUnits("0.000040828373080029", 18);
