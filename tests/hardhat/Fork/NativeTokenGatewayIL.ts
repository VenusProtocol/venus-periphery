...
async function setup() {
  ...
  vusdt = await ethers.getContractAt("@venusprotocol/isolated-pools/contracts/VToken.sol:VToken", VUSDT);
  vweth = await ethers.getContractAt("@venusprotocol/isolated-pools/contracts/VToken.sol:VToken", VWETH);
  ...
  const nativeTokenGatewayFactory = await ethers.getContractFactory(
    "contracts/Gateway/NativeTokenGatewayIL.sol:NativeTokenGateway",
  );
