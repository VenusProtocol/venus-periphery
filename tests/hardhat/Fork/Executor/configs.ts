// ═══════════════════════════════════════════════════════════════════════════
// Executor Fork Test — Network Configurations
// ═══════════════════════════════════════════════════════════════════════════
...
export interface ExecutorNetworkConfig {
  ...
  /** True for BSC Diamond comptroller, false for IL comptroller */
  isCorePool: boolean;
  /** Primary vToken used in most tests — must have non-zero CF, borrow cap, and supply cap */
  testMarket: string;
...
export const bscmainnetConfig: ExecutorNetworkConfig = {
...
export const ethereumConfig: ExecutorNetworkConfig = {
...
export const arbitrumoneConfig: ExecutorNetworkConfig = {
...
export const basemainnetConfig: ExecutorNetworkConfig = {
...
export const opmainnetConfig: ExecutorNetworkConfig = {
...
export const opbnbmainnetConfig: ExecutorNetworkConfig = {
...
export const unichainmainnetConfig: ExecutorNetworkConfig = {
