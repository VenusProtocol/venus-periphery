...
// ═══════════════════════════════════════════════════════════════════════════
// CONSTANTS — Unichain Mainnet
// ═══════════════════════════════════════════════════════════════════════════

const COMPTROLLER = "0xe22af1e6b78318e1Fe1053Edbd7209b8Fc62c4Fe";
const NORMAL_TIMELOCK = "0x918532A78d22419Da4091930d472bDdf532BE89a";
const ACM = "0x1f12014c497a9d905155eB9BfDD9FaC6885e61d0";

const vToken = "0xbEC19Bef402C697a7be315d3e59E5F65b89Fa1BB"; // vwstETH
const vToken2 = "0x67d31Bfa84541E48C5cC10fa5E0Cf502A0c4cB34"; // vUSDC_Core
...
const FORK_NETWORK = process.env.FORKED_NETWORK === "unichainmainnet";
...
if (FORK_NETWORK) {
  ...
  forking(FORK_BLOCK, () => {
    ...
    describe("EBrake Fork Tests (Unichain Mainnet — IL Core Pool)", () => {
      beforeEach(async () => {
        ({
          eBrake,
          comptroller,
