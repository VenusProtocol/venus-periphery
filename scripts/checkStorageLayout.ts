...
/**
 * Mainnets only: testnet layouts drift on purpose.
 *
 * opbnbmainnet, opmainnet and unichainmainnet have no deployments directory yet and contribute
 * nothing today; they are listed ahead of their first deployment so a new chain is covered the day
 * it lands rather than silently skipped. A network with no directory is passed over.
 */
const NETWORKS = [
  "bscmainnet",
  "ethereum",
