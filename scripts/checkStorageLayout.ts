...
/** Mainnets only: testnet layouts drift on purpose. Each must have a deployments directory. */
const NETWORKS = ["bscmainnet", "ethereum", "arbitrumone", "basemainnet"];

/** Every other deployments/ directory. One in neither list fails the run, so a new chain is never
 *  unchecked by default. */
const SKIPPED_NETWORKS = ["bsctestnet", "sepolia", "localhost"];
